...
open my $out, ">:encoding(ISO-8859-15)", "$type.txt";
...
# Tentative de conversion UTF-8 vers ISO, mais ça ne marche pas!
# system ("iconv -f UTF-8 -t ISO-8859-15 $type.txt > $type-iso.txt");
